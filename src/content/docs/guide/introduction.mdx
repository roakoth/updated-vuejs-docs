...
<img style="width: 96px" src="https://storage.googleapis.com/vue-mastery.appspot.com/flamelink/media/vuemastery-graphical-link-96x56.png" alt="vuejs" width="96px" height="56px"/> Learn Vue with Video tutorials on [VueMastery.com](https://www.vuemastery.com/courses/)
...
You can learn more about the **[how and why of SFC](https://vuejs.org/guide/scaling-up/sfc.html)** in its dedicated section 
- but for now, just know that Vue will handle all the build tools setup for you.
